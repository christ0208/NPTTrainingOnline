<?php
    ...
    $detailForumQuery = "SELECT threads.id as id, threads.title as thread_title, threads.detail as thread_detail, threads.upload_file_path as file_path, users.name as user_name FROM threads JOIN users ON users.id = threads.user_id WHERE forum_id=${_GET['id']}";
    ...
    <?php
        while($currentDetailForum = $detailForumResult->fetch_assoc()) {
            ...
            <div class="mt-2">
                ...
                <div class="bg-light p-2">
                    <a href="delete_thread.php?id=<?= $currentDetailForum['id'];?>&forum_id=<?= $_GET['id'];?>">
